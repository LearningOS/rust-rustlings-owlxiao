...
pub trait Licensed {
    fn licensing_info(&self) -> String {
        format!(
            "This software is licensed under version {}",
            self.get_version()
        )
    }
...
mod tests {
    ...
    fn is_licensing_info_the_same() {
        let licensing_info = String::from("This software is licensed under version 1");
        ...
        assert_eq!(
            ...
            "This software is licensed under version v2.0.0"
        );
    }
}
